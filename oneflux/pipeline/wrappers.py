...
DEFAULT_LOGGING_FILENAME = 'FLUXNET2015_{h}_{t}.log'.format(h=HOSTNAME, t=NOW_TS)
...
class Pipeline(object):
    ...
    def run(self):
        ...
        try:
            ...
            logger_file, log_file_handler = add_file_log(filename=os.path.join(self.data_dir, DEFAULT_LOGGING_FILENAME))
...
class PipelineMeteoERA(object):
    ...
    def post_validate(self):
        ...
        # check output files and result report (log)
        test_file_list(file_list=self.output_file_patterns, tdir=self.meteo_era_dir, label='meteo_era.post_validate')
    ...
    def check_era_stat(self, filename=None):
        '''
