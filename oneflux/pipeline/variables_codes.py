...
# NEE_[C|V]UT_XX
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT_L = [] + \
...
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT = {'NEE_CUT_{n}_QC'.format(n=i): VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT_L for i in PERC_LIST}
...
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT_L = [] + \
...
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT = {'NEE_VUT_{n}_QC'.format(n=i): VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT_L for i in PERC_LIST}
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTNIGHT_L = ['NEE_VUT_{n}_NIGHT'.format(n=i) for i in PERC_LIST]
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTNIGHT = {'NEE_VUT_{n}_QC_NIGHT'.format(n=i): VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTNIGHT_L for i in PERC_LIST}
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTDAY_L = ['NEE_VUT_{n}_DAY'.format(n=i) for i in PERC_LIST]
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTDAY = {'NEE_VUT_{n}_QC_DAY'.format(n=i): VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTDAY_L for i in PERC_LIST}
