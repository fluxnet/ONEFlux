...
# New for 2025, do not gapfill long gaps filled with MDS
VARIABLES_DONOT_GAPFILL_LONG_ENERGY = {
    # G
    'G_F_MDS_QC': ['G_F_MDS'],

    # LE
    'LE_F_MDS_QC': ['LE_F_MDS', 'LE_CORR', 'LE_CORR_25', 'LE_CORR_75', 'LE_RANDUNC',],
    
    # H
    'H_F_MDS_QC': ['H_F_MDS', 'H_CORR', 'H_CORR_25', 'H_CORR_75', 'H_RANDUNC', ],
} # VARIABLES_DONOT_GAPFILL_LONG_ENERGY

# NEE, GPP, RECO
VARIABLES_DONOT_GAPFILL_LONG_NEEBASIC = {
    'NEE_CUT_REF_QC': ['NEE_CUT_REF', 'NEE_CUT_REF_RANDUNC', 'NEE_CUT_REF_RANDUNC_METHOD', 'NEE_CUT_REF_RANDUNC_N', 'NEE_CUT_REF_JOINTUNC',
                       'RECO_NT_CUT_REF', 'GPP_NT_CUT_REF', 'RECO_DT_CUT_REF', 'GPP_DT_CUT_REF'],
    'NEE_CUT_REF_NIGHT_QC': ['NEE_CUT_REF_NIGHT', 'NEE_CUT_REF_NIGHT_SD', 'NEE_CUT_REF_NIGHT_RANDUNC', 'NEE_CUT_REF_NIGHT_JOINTUNC', ],
    'NEE_CUT_REF_DAY_QC': ['NEE_CUT_REF_DAY', 'NEE_CUT_REF_DAY_SD', 'NEE_CUT_REF_DAY_RANDUNC', 'NEE_CUT_REF_DAY_JOINTUNC', ],
    'NEE_CUT_USTAR50_QC': ['NEE_CUT_USTAR50', 'NEE_CUT_USTAR50_RANDUNC', 'NEE_CUT_USTAR50_RANDUNC_METHOD', 'NEE_CUT_USTAR50_RANDUNC_N', 'NEE_CUT_USTAR50_JOINTUNC',
                           'RECO_NT_CUT_USTAR50', 'GPP_NT_CUT_USTAR50', 'RECO_DT_CUT_USTAR50', 'GPP_DT_CUT_USTAR50',],
    'NEE_CUT_USTAR50_NIGHT_QC': ['NEE_CUT_USTAR50_NIGHT', 'NEE_CUT_USTAR50_NIGHT_SD', 'NEE_CUT_USTAR50_NIGHT_RANDUNC', 'NEE_CUT_USTAR50_NIGHT_JOINTUNC', ],
    'NEE_CUT_USTAR50_DAY_QC': ['NEE_CUT_USTAR50_DAY', 'NEE_CUT_USTAR50_DAY_SD', 'NEE_CUT_USTAR50_DAY_RANDUNC', 'NEE_CUT_USTAR50_DAY_JOINTUNC', ],
    'NEE_CUT_MEAN_QC': ['NEE_CUT_MEAN', 'RECO_NT_CUT_MEAN', 'GPP_NT_CUT_MEAN', 'RECO_DT_CUT_MEAN', 'GPP_DT_CUT_MEAN',],

    'NEE_VUT_REF_QC': ['NEE_VUT_REF', 'NEE_VUT_REF_RANDUNC', 'NEE_VUT_REF_RANDUNC_METHOD', 'NEE_VUT_REF_RANDUNC_N', 'NEE_VUT_REF_JOINTUNC',
                       'RECO_NT_VUT_REF', 'GPP_NT_VUT_REF', 'RECO_DT_VUT_REF', 'GPP_DT_VUT_REF'],
    'NEE_VUT_REF_NIGHT_QC': ['NEE_VUT_REF_NIGHT', 'NEE_VUT_REF_NIGHT_SD', 'NEE_VUT_REF_NIGHT_RANDUNC', 'NEE_VUT_REF_NIGHT_JOINTUNC', ],
    'NEE_VUT_REF_DAY_QC': ['NEE_VUT_REF_DAY', 'NEE_VUT_REF_DAY_SD', 'NEE_VUT_REF_DAY_RANDUNC', 'NEE_VUT_REF_DAY_JOINTUNC', ],
    'NEE_VUT_USTAR50_QC': ['NEE_VUT_USTAR50', 'NEE_VUT_USTAR50_RANDUNC', 'NEE_VUT_USTAR50_RANDUNC_METHOD', 'NEE_VUT_USTAR50_RANDUNC_N', 'NEE_VUT_USTAR50_JOINTUNC',
                           'RECO_NT_VUT_USTAR50', 'GPP_NT_VUT_USTAR50', 'RECO_DT_VUT_USTAR50', 'GPP_DT_VUT_USTAR50',],    
    'NEE_VUT_USTAR50_NIGHT_QC': ['NEE_VUT_USTAR50_NIGHT', 'NEE_VUT_USTAR50_NIGHT_SD', 'NEE_VUT_USTAR50_NIGHT_RANDUNC', 'NEE_VUT_USTAR50_NIGHT_JOINTUNC', ],
    'NEE_VUT_USTAR50_DAY_QC': ['NEE_VUT_USTAR50_DAY', 'NEE_VUT_USTAR50_DAY_SD', 'NEE_VUT_USTAR50_DAY_RANDUNC', 'NEE_VUT_USTAR50_DAY_JOINTUNC', ],
    'NEE_VUT_MEAN_QC': ['NEE_VUT_MEAN', 'RECO_NT_VUT_MEAN', 'GPP_NT_VUT_MEAN', 'RECO_DT_VUT_MEAN', 'GPP_DT_VUT_MEAN',],
} # VARIABLES_DONOT_GAPFILL_LONG_NEEBASIC

PERC_LIST = ['05', '16', '25', '50', '75', '84', '95']

# NEE_[C|V]UT_XX
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT_L = ['NEE_CUT_{n}', 'RECO_NT_CUT_{n}', 'GPP_NT_CUT_{n}', 'RECO_DT_CUT_{n}', 'GPP_DT_CUT_{n}',]
# + \
#     ['NEE_CUT_{n}'.format(n=i) for i in PERC_LIST] + \
#     ['RECO_NT_CUT_{n}'.format(n=i) for i in PERC_LIST] + \
#     ['GPP_NT_CUT_{n}'.format(n=i) for i in PERC_LIST] + \
#     ['RECO_DT_CUT_{n}'.format(n=i) for i in PERC_LIST] + \
#     ['GPP_DT_CUT_{n}'.format(n=i) for i in PERC_LIST]
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT = {'NEE_CUT_{n}_QC'.format(n=i): [j.format(n=i) for j in VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT_L] for i in PERC_LIST}
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUTNIGHT_L = ['NEE_CUT_{n}_NIGHT'.format(n=i) for i in PERC_LIST]
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUTNIGHT = {'NEE_CUT_{n}_QC_NIGHT'.format(n=i): VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUTNIGHT_L for i in PERC_LIST}
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUTDAY_L = ['NEE_CUT_{n}_DAY'.format(n=i) for i in PERC_LIST]
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUTDAY = {'NEE_CUT_{n}_QC_DAY'.format(n=i): VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUTDAY_L for i in PERC_LIST}

VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT_L = ['NEE_VUT_{n}', 'RECO_NT_VUT_{n}', 'GPP_NT_VUT_{n}', 'RECO_DT_VUT_{n}', 'GPP_DT_VUT_{n}', ]
# + \
#     ['NEE_VUT_{n}'.format(n=i) for i in PERC_LIST] + \
#     ['RECO_NT_VUT_{n}'.format(n=i) for i in PERC_LIST] + \
#     ['GPP_NT_VUT_{n}'.format(n=i) for i in PERC_LIST] + \
#     ['RECO_DT_VUT_{n}'.format(n=i) for i in PERC_LIST] + \
#     ['GPP_DT_VUT_{n}'.format(n=i) for i in PERC_LIST]
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT = {'NEE_VUT_{n}_QC'.format(n=i): [j.format(n=i) for j in VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT_L] for i in PERC_LIST}
# VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTNIGHT_L = ['NEE_VUT_{n}_NIGHT'.format(n=i) for i in PERC_LIST]
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTNIGHT = {'NEE_VUT_{n}_QC_NIGHT'.format(n=i): 'NEE_VUT_{n}_NIGHT'.format(n=i) for i in PERC_LIST}
# VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTDAY_L = ['NEE_VUT_{n}_DAY'.format(n=i) for i in PERC_LIST]
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTDAY = {'NEE_VUT_{n}_QC_DAY'.format(n=i): 'NEE_VUT_{n}_DAY'.format(n=i) for i in PERC_LIST}

# VARIABLES_DONOT_GAPFILL_LONG_PART = {
#     'RECO_NT_VUT_REF_QCC': 'RECO_NT_VUT_REF',
#     'RECO_NT_CUT_REF_QCC': 'RECO_NT_CUT_REF',
#     'GPP_NT_VUT_REF_QCC': 'GPP_NT_VUT_REF',
#     'GPP_NT_CUT_REF_QCC': 'GPP_NT_CUT_REF',
#     'RECO_DT_VUT_REF_QCC': 'RECO_DT_VUT_REF',
#     'RECO_DT_CUT_REF_QCC': 'RECO_DT_CUT_REF',
#     'GPP_DT_VUT_REF_QCC': 'GPP_DT_VUT_REF',
#     'GPP_DT_CUT_REF_QCC': 'GPP_DT_CUT_REF', 
# }

# List of dictionaries to merge
VARIABLES_DONOT_GAPFILL_LONG_TO_UPDATE = [
	VARIABLES_DONOT_GAPFILL_LONG_ENERGY,
	VARIABLES_DONOT_GAPFILL_LONG_NEEBASIC,
	VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT,
	VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUTNIGHT,
	VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUTDAY,
	VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT,
	VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTNIGHT,
	VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUTDAY,
	# VARIABLES_DONOT_GAPFILL_LONG_PART,
]
VARIABLES_DONOT_GAPFILL_LONG = {}
for d in VARIABLES_DONOT_GAPFILL_LONG_TO_UPDATE:
    VARIABLES_DONOT_GAPFILL_LONG.update(d)

# List of variables that should not be gapfilled for long gaps, for all _MEAN versions
VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT_MEAN_L = []
VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT_MEAN_L = []
for i in PERC_LIST:
    VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT_MEAN_L.extend([j.format(n=i) + '_QC' for j in VARIABLES_DONOT_GAPFILL_LONG_NEEXXCUT_L])
    VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT_MEAN_L.extend([j.format(n=i) + '_QC' for j in VARIABLES_DONOT_GAPFILL_LONG_NEEXXVUT_L])

# TODO: [
#   'NEE_CUT_SE', 'NEE_VUT_SE',
#   'RECO_NT_CUT_SE', 'RECO_NT_VUT_SE', 'RECO_DT_CUT_SE', 'RECO_DT_VUT_SE',
#   'GPP_NT_CUT_SE', 'GPP_NT_VUT_SE', 'GPP_DT_CUT_SE', 'GPP_DT_VUT_SE', 
# ]
# TODO: CHECK: [
#   'RECO_NT_VUT_MEAN', 'RECO_NT_CUT_MEAN', 'GPP_NT_VUT_MEAN', 'GPP_NT_CUT_MEAN', 
#   'RECO_DT_VUT_MEAN', 'RECO_DT_CUT_MEAN', 'GPP_DT_VUT_MEAN', 'GPP_DT_CUT_MEAN', 
...
#
#
# END: New for 2025, do not gapfill long gaps filled with MDS
