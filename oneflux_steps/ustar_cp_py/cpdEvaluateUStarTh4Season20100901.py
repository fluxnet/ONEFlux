...
@function
def cpdEvaluateUStarTh4Season20100901(t=None,NEE=None,uStar=None,T=None,fNight=None,fPlot=None,cSiteYr=None,varargin=None,*args,**kwargs):
...
# oneflux_steps/ustar_cp_refactor_wip/cpdEvaluateUStarTh4Season20100901.m:135
                ...
                jtSeason=arange((dot((iSeason - 1),nPerSeason) + 1),(dot(iSeason,nPerSeason)))
...
# oneflux_steps/ustar_cp_refactor_wip/cpdEvaluateUStarTh4Season20100901.m:153
            n,muStar,mNEE=fcBin(uStar[itStrata],NEE[itStrata],[],nPerBin,nargout=3)
# oneflux_steps/ustar_cp_refactor_wip/cpdEvaluateUStarTh4Season20100901.m:155
            xCp2,xs2,xCp3,xs3=cpdFindChangePoint20100901(muStar,mNEE,fPlot,cPlot,nargout=4)
