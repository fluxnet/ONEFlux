...
@function
def cpdBootstrapUStarTh20100901(t=None,NEE=None,uStar=None,T=None,fNight=None,fPlot=None,cSiteYr=None,nBoot=None,*args,**kwargs):
...
# oneflux_steps/ustar_cp_refactor_wip/cpdBootstrapUStarTh20100901.m:96
    ...
    disp(' ')
    fprintf('cpdBootstrapUStarTh20100901  %s   nObs: %g %g %g %g \n',cSiteYr,nt,sum(logical_not(isnan(concat([NEE,uStar,T])))))
    disp(' ')
    #	Bootstrapping.
...
# oneflux_steps/ustar_cp_refactor_wip/cpdBootstrapUStarTh20100901.m:116
            xCp2,xStats2,xCp3,xStats3=cpdEvaluateUStarTh20100901(t[it],NEE[it],uStar[it],T[it],fNight[it],fPlot,cSiteYr,nargout=4)
