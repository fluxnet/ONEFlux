...
@function
def cpdBootstrapUStarTh4Season20100901(t=None,NEE=None,uStar=None,T=None,fNight=None,fPlot=None,cSiteYr=None,nBoot=None,varargin=None,*args,**kwargs):
...
# oneflux_steps/ustar_cp_refactor_wip/cpdBootstrapUStarTh4Season20100901.m:108
            xCp2,xStats2,xCp3,xStats3=cpdEvaluateUStarTh4Season20100901(t[it],NEE[it],updated_uStar[it],T[it],fNight[it],fPlot,cSiteYr,nargout=4)
