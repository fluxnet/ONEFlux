...
# ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m
...
def mydatevec(t=None, *args, **kwargs):
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:6
    y = dot(NaN, ones(size(t)))
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:8
    m = copy(y)
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:8
    d = copy(y)
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:8
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:10
    y[iYaN] = yy
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:11
    m[iYaN] = mm
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:11
    d[iYaN] = dd
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:11
    h[iYaN] = hh
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:12
    mn[iYaN] = mmn
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:12
    s[iYaN] = ss
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:12
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:16
    y2400, m2400, d2400, q, q, q = datevec(t(i2400) - 1, nargout=6)
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:17
    y[i2400] = y2400
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:18
    m[i2400] = m2400
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:18
    d[i2400] = d2400
    # ../ONEFlux/oneflux_steps/ustar_cp/fcDatevec.m:18
