...
# ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m
...
def cpdBootstrapUStarTh20100901(
    ...
    **kwargs
    ...
    nt = length(t)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:61
    nPerDay = round(1 / nanmedian(diff(t)))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:62
    nWindowsN = 4
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:64
    nStrata = 4
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:64
    nBins = 50
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:64
    ...
    if 24 == nPerDay:
        nPerBin = 3
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:66
    else:
        if 48 == nPerDay:
            nPerBin = 5
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:67

    nPerWindow = dot(dot(nStrata, nBins), nPerBin)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:69
    nInc = dot(0.5, nPerWindow)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:70
    ntN = dot(nWindowsN, nPerWindow)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:71
    iNight = find(fNight)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:73
    uStar[uStar < logical_or(0, uStar) > 4] = NaN
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:74

    itNee = find(logical_not(isnan(NEE + uStar + T)))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:76
    itNee = intersect(itNee, iNight)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:76
    ntNee = length(itNee)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:77
    nWindows = ceil(ntNee / nInc) + 1
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:78

    StatsMT = []
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:80
    StatsMT.n = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:81
    StatsMT.Cp = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:81
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:81
    StatsMT.b0 = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:82
    StatsMT.b1 = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:82
    StatsMT.b2 = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:82
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:83
    StatsMT.cib1 = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:83
    StatsMT.cic2 = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:83
    StatsMT.mt = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:84
    StatsMT.ti = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:84
    StatsMT.tf = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:84
    StatsMT.ruStarVsT = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:85
    StatsMT.puStarVsT = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:85
    StatsMT.mT = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:86
    StatsMT.ciT = copy(NaN)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:86
    Cp2 = dot(NaN, ones(nWindows, nStrata, nBoot))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:88
    Cp3 = dot(NaN, ones(nWindows, nStrata, nBoot))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:89
    Stats2 = copy(StatsMT)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:91
    Stats3 = copy(StatsMT)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:91
    for iBoot in arange(1, nBoot).reshape(-1):
        for iWindow in arange(1, nWindows).reshape(-1):
            for iStrata in arange(1, nStrata).reshape(-1):
                ...
                # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:95
                Stats3[iWindow, iStrata, iBoot] = StatsMT
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:96
    ...
    if ntNee >= ntN:
        for iBoot in arange(1, nBoot).reshape(-1):
            t0 = copy(now)
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:111
            it = sort(randi(nt, nt, 1))
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:113
            ntNee = sum(ismember(it, itNee))
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:114
            if iBoot > 1:
                fPlot = 0
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:116
            xCp2, xStats2, xCp3, xStats3 = cpdEvaluateUStarTh20100901(
                t(it), NEE(it), uStar(it), T(it), fNight(it), fPlot, cSiteYr, nargout=4
            )
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:118
            nW, nS = size(xCp2, nargout=2)
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:122
            dt = dot(dot(dot((now - t0), 24), 60), 60)
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:123
            fprintf(
            ...
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:127
            Stats2[arange(1, nW), arange(), iBoot] = xStats2
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:127
            Cp3[arange(1, nW), arange(), iBoot] = xCp3
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdBootstrapUStarTh20100901.m:128
