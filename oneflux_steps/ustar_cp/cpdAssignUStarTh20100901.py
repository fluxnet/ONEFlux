...
# ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m
...
def cpdAssignUStarTh20100901(Stats=None, fPlot=None, cSiteYr=None, *args, **kwargs):
    ...
    CpA = []
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:66
    nA = []
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:66
    tW = []
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:66
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:66
    FracSig = []
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:67
    FracModeD = []
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:67
    FracSelect = []
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:67
    ...
    nDim = ndims(Stats)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:71
    if 2 == nDim:
        nWindows, nBoot = size(Stats, nargout=2)
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:73
        nStrata = 1
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:73
        nStrataN = 0.5
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:73
        ...
        if 3 == nDim:
            ...
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:74
            nStrataN = 1
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:74
        else:
            cFailure = "Stats must be 2D or 3D."
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:75
            return (
                CpA,
                nA,
                tW,
    ...
    nWindowsN = 4
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:77
    nSelectN = dot(dot(nWindowsN, nStrataN), nBoot)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:77
    CpA = dot(NaN, ones(nBoot, 1))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:79
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:85
    nVars = length(cVars)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:85
    for i in arange(1, nVars).reshape(-1):
        cv = char(cVars(i))
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:87
        eval(concat([cv, "=fcReadFields(Stats,'", cv, "');"]))
        if "mt" == cv:
            xmt = copy(mt)
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:89
        else:
            if "Cp" == cv:
                xCp = copy(Cp)
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:90
        eval(concat([cv, "=fcx2colvec(", cv, ");"]))

    pSig = 0.05
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:95
    fP = p <= pSig
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:95
    ...
    nPar = 3
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:101
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:108
    nTry = length(iTry)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:108
    iCp = find(logical_not(isnan(b1 + c2 + Cp)))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:109
    nCp = length(iCp)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:109
    iNS = find(fP == logical_and(0, logical_not(isnan(b1 + c2 + Cp))))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:110
    nNS = length(iNS)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:110
    iSig = find(fP == logical_and(1, logical_not(isnan(b1 + c2 + Cp))))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:111
    nSig = length(iSig)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:111
    iModeE = find(fP == logical_and(1, b1) < c2)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:112
    nModeE = length(iModeE)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:112
    iModeD = find(fP == logical_and(1, b1) >= c2)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:113
    ...
    if nModeD >= nModeE:
        iSelect = copy(iModeD)
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:117
        cMode = "D"
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:117
    else:
        iSelect = copy(iModeE)
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:118
    fSelect[iSelect] = 1
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:118
    fSelect = logical(fSelect)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:118
    fModeD = dot(NaN, ones(size(fP)))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:119
    fModeD[iModeD] = 1
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:119
    fModeE = dot(NaN, ones(size(fP)))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:120
    fModeE[iModeE] = 1
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:120
    FracSig = nSig / nTry
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:122
    ...
    if FracSelect < 0.1:
        ...
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:126
        return (
            CpA,
            nA,
            tW,
    ...
    if 2 == nPar:
        x = concat([Cp, b1, cib1])
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:131
        nx = 3
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:131
    else:
        if 3 == nPar:
            x = concat([Cp, b1, c2, cib1, cic2])
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:132
            nx = 5
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:132

    mx = nanmedian(x)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:135
    sx = fcNaniqr(x)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:135
    xNorm = dot(NaN, x)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:136
    for i in arange(1, nx).reshape(-1):
        xNorm[arange(), i] = (x(arange(), 1) - mx(i)) / sx(i)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:136

    xNormX = max(abs(xNorm), [], 2)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:137
    ns = 5
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:138
    fOut = xNormX > ns
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:138
    iOut = find(fOut)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:138
    iSelect = setdiff(iSelect, iOut)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:139
    nSelect = length(iSelect)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:139
    fSelect = logical_and(logical_not(fOut), fSelect)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:140
    fModeD[iOut] = NaN
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:141
    iModeD = find(fModeD == 1)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:141
    nModeD = length(iModeD)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:141
    fModeE[iOut] = NaN
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:142
    iModeE = find(fModeE == 1)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:142
    nModeE = length(iModeE)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:142
    iSig = union(iModeD, iModeE)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:143
    nSig = length(iSig)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:143
    FracSig = nSig / nTry
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:145
    FracModeD = nModeD / nSig
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:145
    FracSelect = nSelect / nTry
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:145
    if nSelect < nSelectN:
        ...
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:147
        return (
            CpA,
            nA,
            tW,
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:151
    ...
    if 2 == nDim:
        ...
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:153
        nA = fcx2colvec(sum(logical_not(isnan(xCpSelect))))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:154
    else:
        if 3 == nDim:
            CpA = fcx2colvec(nanmean(reshape(xCpGF, dot(nWindows, nStrata), nBoot)))
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:155
            nA = fcx2colvec(
                sum(
                    logical_not(
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:156
    ...
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:163
    mtSelect, i = sort(mt(iSelect), nargout=2)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:164
    CpSelect = Cp(iSelect(i))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:164
    xBins = prctile(mtSelect, arange(0, 100, (100 / nW)))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:165
    n, tW, CpW = fcBin(mtSelect, CpSelect, xBins, 0, nargout=3)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:166
    # 	Fit annual sine curve

    bSine = concat([1, 1, 1])
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:170
    bSine = nlinfit(mt(iSelect), Cp(iSelect), "fcEqnAnnualSine", bSine)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:171
    yHat = fcEqnAnnualSine(bSine, mt(iSelect))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:172
    r2 = fcr2Calc(Cp(iSelect), yHat)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:172
    mtHat = sort(mt(iSelect))
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:173
    CpHat = fcEqnAnnualSine(bSine, mtHat)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:173
    if bSine(2) < 0:
        bSine[2] = -bSine(2)
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:175
        bSine[3] = bSine(3) + 365.25 / 2
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:175

    bSine[3] = mod(bSine(3), 365.25)
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:176
    sSine = concat([fcx2rowvec(bSine), r2])
    # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:177
    # 	=======================================================================
    # 	=======================================================================
    ...
    if fPlot:
        ...
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:184
        mtByWindow = nanmean(reshape(xmt, nWindows, dot(nStrata, nBoot)), 2)
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:185
        ...
        nBins = copy(nWindows)
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:191
        if nModeD >= dot(nBins, 30):
            n, mx, my = fcBin(
                mt(iModeD), Cp(iModeD), [], round(nModeD / nBins), nargout=3
            )
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:193
            hold("on")
        ...
        if nModeE >= dot(nBins, 30):
            ...
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:197
            hold("on")
        ...
        if "G" == cMode:
            c = "g"
        # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:208
        else:
            if "L" == cMode:
                c = "b"
            # ../ONEFlux/oneflux_steps/ustar_cp/cpdAssignUStarTh20100901.m:208
