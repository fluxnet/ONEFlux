...
typedef struct {
	...
	PREC night_columns_y[PERCENTILES_COUNT_2];
	PREC day_columns_y[PERCENTILES_COUNT_2];
	PREC night_qc_columns_y[PERCENTILES_COUNT_2];
	PREC day_qc_columns_y[PERCENTILES_COUNT_2];

	PREC night_columns_c[PERCENTILES_COUNT_2];
	PREC day_columns_c[PERCENTILES_COUNT_2];
	PREC night_qc_columns_c[PERCENTILES_COUNT_2];
	PREC day_qc_columns_c[PERCENTILES_COUNT_2];
} ROW_NIGHT;
...
typedef struct {
	...
	PREC qc_ori[PERCENTILES_COUNT_2];
} NEE_MATRIX;
